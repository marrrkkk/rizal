...
const LevelCompletionModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in overflow-y-auto">
      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl max-w-xl w-full border-4 border-green-200">
          {/* Header */}
          <div className="bg-gradient-to-r from-green-500 via-emerald-500 to-green-600 text-white p-6 rounded-t-3xl text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-20 h-20 bg-white/30 rounded-full mx-auto mb-3 flex items-center justify-center animate-bounce shadow-2xl border-4 border-white/50">
