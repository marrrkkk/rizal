...
export default function CharacterConnectionsGame({ username, onComplete }) {
  return (
    <DndProvider backend={HTML5Backend}>
      <CharacterConnectionsContent username={username} onComplete={onComplete} />
    </DndProvider>
  )
}
...
function CharacterConnectionsContent({ username, onComplete }) {
  const [connections, setConnections] = useState([
    { id: 1, character: "Crisostomo Ibarra", role: "Protagonist, idealistic young man", matched: false },
    { id: 2, character: "Maria Clara", role: "Ibarra's love interest, daughter of Captain Tiago", matched: false },
    { id: 3, character: "Padre Damaso", role: "Franciscan friar, Maria Clara's biological father", matched: false },
    { id: 4, character: "Elias", role: "Mysterious man who helps Ibarra", matched: false },
    { id: 5, character: "Sisa", role: "Mother of Basilio and Crispin", matched: false },
  ])

  const [descriptions, setDescriptions] = useState([
    { id: 1, text: "Son of Don Rafael Ibarra, returns to the Philippines after studying in Europe" },
    { id: 2, text: "Raised by Captain Tiago, known for her beauty and kindness" },
    { id: 3, text: "Former town curate, represents the corrupt Spanish friars" },
    { id: 4, text: "A fugitive who becomes Ibarra's ally, represents the common Filipino" },
      ...
      >
        {isMatched ? (
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">{matchedCharacter.character}</div>
          </div>
        ) : (
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-purple-800">Character Connections</h1>
        ...
        {showHint && (
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded">
            <p className="text-blue-700">
              <strong>Hint:</strong> Drag each character to its matching description. Match all characters to complete the game!
            </p>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Characters */}
          <div>
            <h2 className="text-xl font-semibold mb-4 text-gray-800">Characters</h2>
            <div className="space-y-4">
              {connections.map(character => (
                !character.matched && (
          ...
          {/* Descriptions */}
          <div>
            <h2 className="text-xl font-semibold mb-4 text-gray-800">Match the Descriptions</h2>
        ...
        {completed && (
          <div className="mt-8 p-6 bg-green-50 border border-green-200 rounded-lg text-center">
            ...
            <p className="text-green-700 mb-4">You've matched all characters correctly with a score of {score}!</p>
            <button
              onClick={resetGame}
