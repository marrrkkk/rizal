...
export default function EarlyChildhoodGame({ username, onLogout }) {
          ...
          <button
            ...
            className={`p-6 rounded-2xl border-4 transition-all duration-200 text-left font-semibold ${
              showQuizResult
                ...
                ? "bg-green-100 border-green-400 text-green-800"
                : "bg-gray-50 border-gray-200 text-black hover:bg-green-50 hover:border-green-300"
            }`}
          >
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-green-100 via-yellow-100 to-orange-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-12 h-12 bg-green-300 rounded-full opacity-15"></div>
        <div className="absolute bottom-32 left-20 w-20 h-20 bg-orange-300 rounded-full opacity-10"></div>
        <div className="absolute bottom-20 right-10 w-14 h-14 bg-red-300 rounded-full opacity-15"></div>
      ...
      <header className="bg-white shadow-lg sticky top-0 z-10 border-b-4 border-green-400">
        <div className="w-full px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            <div className="bg-white/90 rounded-full px-4 py-2 shadow-md border-2 border-green-200">
      ...
      <main className="w-full px-6 py-8 relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-block bg-white/95 backdrop-blur-sm rounded-3xl p-6 shadow-xl border-4 border-green-200">
            <div className="text-6xl mb-4">🌱</div>
            <h2 className="text-3xl font-black text-gray-800 mb-2">
              {games[currentGame].title}
            </h2>
            <p className="text-gray-600 font-medium">
              Explore Jose's first years
            </p>
          </div>
        </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 shadow-xl border-4 border-yellow-200">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Learn about young Jose</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-50 rounded-2xl p-4 border-2 border-blue-200">
                ...
                <p className="text-gray-700 text-sm">
                  Jose learned to read at age 3 under the mango tree
                </p>
              </div>
              <div className="bg-green-50 rounded-2xl p-4 border-2 border-green-200">
                ...
                <p className="text-gray-700 text-sm">
                  He loved drawing flowers, birds, and nature scenes
                </p>
              </div>
            </div>
          </div>
