...
export default function LettersAbroadGame({ onComplete }) {
  ...
  const correspondences = [
    {
      id: 1,
      recipient: "Ferdinand Blumentritt",
      content: "Discussed Philippine history and culture",
    },
    {
      id: 2,
      recipient: "Paciano Rizal",
      content: "Family matters and revolutionary ideas",
    },
    {
      id: 3,
      recipient: "Marcelo H. del Pilar",
      content: "Propaganda Movement strategies",
    },
    {
      id: 4,
      recipient: "Jose Ma. Basa",
      content: "Financial support for the movement",
    },
    {
      id: 5,
      recipient: "Graciano Lopez Jaena",
      content: "La Solidaridad publication",
    },
    {
      id: 6,
      recipient: "Mariano Ponce",
      content: "Political developments in Europe",
    },
  ];
  ...
  const handleCardClick = (index) => {
    ...
    if (
      ...
      solved.includes(cards[index].pairId)
    ) {
      return;
    }
  ...
  const renderCard = (card, index) => {
    ...
    const isClickable =
      !isFlipped && flipped.length < 2 && !solved.includes(card.pairId);
      ...
      >
        ...
        >
          {card.type === "recipient" ? (
            ...
            <span className="text-lg text-black">Letter Content</span>
          )}
        </div>
      </div>
    );
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {isComplete ? (
        <div className="text-center py-10">
          ...
          <p className="mb-6">
            You've matched all of Rizal's correspondences in {moves} moves!
          </p>
          <button
            onClick={resetGame}
