...
export default function LigaTimelineGame({ username, onComplete }) {
              ...
              {shuffledEvents.map((event, index) => (
                ...
                >
                  <div className="flex items-center">
                    <div className="flex-shrink-0 h-8 w-8 rounded-full bg-indigo-100 text-indigo-800 flex items-center justify-center font-medium mr-4">
                      {index + 1}
                    </div>
