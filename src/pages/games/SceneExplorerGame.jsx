...
export default function SceneExplorerGame({ username, onComplete }) {
  const scenes = [
    {
      id: 1,
      ...
      questions: [
        {
          id: 1,
          question: "What was Padre Damaso's reaction when he first saw Ibarra?",
          options: ["He welcomed him", "He ignored him", "He left the party", "He insulted Ibarra's father"],
          correct: 3,
          explanation: "Padre Damaso insulted Ibarra's late father, showing his disrespect."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: ["It was successful", "It was sabotaged", "No one came", "It was stopped"],
          correct: 1,
          explanation: "The school was sabotaged, with explosives hidden in the cornerstone."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: ["She chose to", "Her father forced her", "She was heartbroken", "To escape marriage"],
          correct: 1,
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 flex items-center justify-center p-6">
        <div className="bg-white rounded-xl shadow-xl p-8 max-w-md w-full text-center">
          <h1 className="text-3xl font-bold text-indigo-900 mb-4">Scene Explorer Complete!</h1>
          <div className="text-5xl font-bold text-indigo-700 my-6">{score}</div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 p-6">
      <div className="max-w-3xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-indigo-900">Scene Explorer</h1>
            <p className="text-indigo-700">Analyze key scenes from Noli Me Tangere</p>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              <div>Scene {currentSceneIndex + 1} of {scenes.length}</div>
